import { unsafeCSS, LitElement, LitElement as LitElement$1, html, html as html$1 } from "https://cdn.skypack.dev/lit";
import { query, property, customElement, query as query$1, property as property$1, customElement as customElement$1 } from "https://cdn.skypack.dev/lit/decorators";
import { map } from "https://cdn.skypack.dev/lit/directives/map";
import { ifDefined } from "https://cdn.skypack.dev/lit-html/directives/if-defined";
import { css, svg, svg as svg$1 } from "https://cdn.skypack.dev/lit-element";
import { classMap } from "https://cdn.skypack.dev/lit-html/directives/class-map";
import { directive } from "https://cdn.skypack.dev/lit-html/directive";
var axios$2 = { exports: {} };
...
const spread2 = directive((attributesInfo) => (part) => {
  if (!(part) || part.committer.name !== ".." || part.committer.parts.length > 1) {
...
const selectorTabbable = `
  ...
  textarea:not([disabled]):not([tabindex='-1']),
  iframe, object, embed, *[tabindex]:not([tabindex='-1']), *[contenteditable=true],
  ${prefix$a}-accordion-item,
  ${prefix$a}-btn,
  ${prefix$a}-breadcrumb-link,
  ${prefix$a}-checkbox,
  ${prefix$a}-code-snippet,
  ${prefix$a}-combo-box,
  ${prefix$a}-content-switcher-item,
  ${prefix$a}-copy-button,
  ${prefix$a}-table-header-row,
  ${prefix$a}-table-row,
  ${prefix$a}-table-toolbar-search,
  ${prefix$a}-date-picker-input,
  ${prefix$a}-dropdown,
  ${prefix$a}-input,
  ${prefix$a}-link,
  ${prefix$a}-number-input,
  ${prefix$a}-modal,
  ${prefix$a}-modal-close-button,
  ${prefix$a}-multi-select,
  ${prefix$a}-inline-notification,
  ${prefix$a}-toast-notification,
  ${prefix$a}-overflow-menu,
  ${prefix$a}-overflow-menu-item,
  ${prefix$a}-page-sizes-select,
  ${prefix$a}-pages-select,
  ${prefix$a}-progress-step,
  ${prefix$a}-radio-button,
  ${prefix$a}-search,
  ${prefix$a}-slider,
  ${prefix$a}-slider-input,
  ${prefix$a}-structured-list,
  ${prefix$a}-tab,
  ${prefix$a}-filter-tag,
  ${prefix$a}-textarea,
  ${prefix$a}-clickable-tile,
  ${prefix$a}-expandable-tile,
  ${prefix$a}-radio-tile,
  ${prefix$a}-selectable-tile,
  ${prefix$a}-toggle,
  ${prefix$a}-tooltip,
  ${prefix$a}-tooltip-definition,
  ${prefix$a}-tooltip-icon,
  ${prefix$a}-header-menu,
  ${prefix$a}-header-menu-button,
  ${prefix$a}-header-menu-item,
  ${prefix$a}-header-name,
  ${prefix$a}-header-nav-item,
  ${prefix$a}-side-nav-link,
  ${prefix$a}-side-nav-menu,
  ${prefix$a}-side-nav-menu-item
`;
/**
 * @license
 *
...
let _$6 = (t) => t, _t$7, _t2$3, _t3$1;
const {
  prefix: prefix$9
} = settings_1;
let BXButton = _decorate([customElement(`${prefix$9}-btn`)], function(_initialize, _HostListenerMixin) {
    ...
    d: [{
      ...
      value: function render() {
        ...
        const classes = classMap({
          [`${prefix$9}--btn`]: true,
          [`${prefix$9}--btn--${kind}`]: kind,
          [`${prefix$9}--btn--disabled`]: disabled,
          [`${prefix$9}--btn--icon-only`]: hasIcon && !hasMainContent,
          [`${prefix$9}--btn--sm`]: size === "sm" && !isExpressive,
          [`${prefix$9}--btn--xl`]: size === "xl",
          [`${prefix$9}--btn--field`]: size === "field" && !isExpressive,
          [`${prefix$9}-ce--btn--has-icon`]: hasIcon,
          [`${prefix$9}--btn--expressive`]: isExpressive
        });
        if (href) {
          return disabled ? html(_t$7 || (_t$7 = _$6` <p id="button" part="button" class="${0}"> <slot @slotchange="${0}"></slot> <slot name="icon" @slotchange="${0}"></slot> </p> `), classes, handleSlotChange, handleSlotChange) : html(_t2$3 || (_t2$3 = _$6` <a id="button" part="button" role="${0}" class="${0}" download="${0}" href="${0}" hreflang="${0}" ping="${0}" rel="${0}" target="${0}" type="${0}"> <slot @slotchange="${0}"></slot> <slot name="icon" @slotchange="${0}"></slot> </a> `), ifNonNull(linkRole), classes, ifNonNull(download), ifNonNull(href), ifNonNull(hreflang), ifNonNull(ping), ifNonNull(rel), ifNonNull(target), ifNonNull(type), handleSlotChange, handleSlotChange);
        }
        return html(_t3$1 || (_t3$1 = _$6` <button id="button" part="button" class="${0}" ?autofocus="${0}" ?disabled="${0}" type="${0}"> <slot @slotchange="${0}"></slot> <slot name="icon" @slotchange="${0}"></slot> </button> `), classes, autofocus, disabled, ifNonNull(type), handleSlotChange, handleSlotChange);
      }
    }, {
      kind: "field",
      static: true,
...
let _$5 = (t) => t, _t$6, _t2$2;
const {
  prefix: prefix$8
} = settings_1;
_decorate([customElement(`${prefix$8}-btn-skeleton`)], function(_initialize, _BXButton) {
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        ...
        const classes = classMap({
          [`${prefix$8}--btn`]: true,
          [`${prefix$8}--skeleton`]: true,
          [`${prefix$8}--btn--${size}`]: size
        });
        return href ? html(_t$6 || (_t$6 = _$5` <a id="button" role="button" class="${0}" download="${0}" href="${0}" hreflang="${0}" ping="${0}" rel="${0}" target="${0}" type="${0}" @click="${0}"></a> `), classes, ifNonNull(download), ifNonNull(href), ifNonNull(hreflang), ifNonNull(ping), ifNonNull(rel), ifNonNull(target), ifNonNull(type), this._handleClickLinkSkeleton) : html(_t2$2 || (_t2$2 = _$5` <button id="button" class="${0}" ?autofocus="${0}" ?disabled="${0}" type="${0}"></button> `), classes, autofocus, disabled, ifNonNull(type));
      }
    }, {
      kind: "field",
      static: true,
